          ...
          <form method="POST" action="#">
            ...
            <div class="mt-6">
              ...
              <div class="mt-1 flex rounded-md shadow-sm">
                ...
                <input id="username" name="username" placeholder="john" type="text" required class="flex-1 form-input pl-3 block w-full rounded-none rounded-r-md transition duration-150 ease-in-out sm:text-sm sm:leading-5">
              </div>
            </div>
